...
namespace FoundationDonationSystem.ViewModels
{
    public class PostEditViewModel
    {
        ...
        // =========================================================
        public int? GalleryImage1Id { get; set; }
        public string? GalleryImage1Path { get; set; }
        public bool RemoveGalleryImage1 { get; set; }
        public int? GalleryImage2Id { get; set; }
        public string? GalleryImage2Path { get; set; }
        public bool RemoveGalleryImage2 { get; set; }
        public int? GalleryImage3Id { get; set; }
        public string? GalleryImage3Path { get; set; }
        public bool RemoveGalleryImage3 { get; set; }
        // =========================================================
        // NEW GALLERY IMAGES
        // =========================================================
