        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DonationNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    PaymentProofOriginalName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DonationSlipNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SlipGeneratedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FoundationName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoundationSettings", x => x.Id);
                });
            migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonationSlips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DonationSlips_Donations_DonationId",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "DonationId");
            migrationBuilder.CreateIndex(
                name: "IX_DonationSlips_SlipNumber",
                table: "DonationSlips",
                column: "SlipNumber",
                unique: true);
            migrationBuilder.CreateIndex(
                name: "IX_FoundationSettings_FoundationName",
                table: "FoundationSettings",
                column: "FoundationName");
            migrationBuilder.CreateIndex(
                name: "IX_PaymentAccounts_IsActive",
